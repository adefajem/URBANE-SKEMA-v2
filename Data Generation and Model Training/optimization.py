...
def Last_Mile_Follower(y, lamda, V2d, A2d, fol_depot, locker_nodes, packages, destinations, num_vehicles_for_follower,
                    ...
                    earliest, latest, leave_time_start, leave_time_end, emissions_matrix_EV, time_violation_penalty, time_limit_seconds,mip_emphasis):
    ...
    return obj_val, best_bound, mip_gap, solve_time, sol_df
